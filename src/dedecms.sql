...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-12-25 15:30:27
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
(1, 10, 'admin', 'f297a57a5a743894a0e4', 'admin', '', '', '0', 1482675508, '127.0.0.1');
...
(41, 4, '0', 1270604213, '', 0, 1, 0, 0, 0, 'JavaScript：世界上误解最深的语言', '', '', '', '', '', 1270604213, 1270604213, 1, 'JavaScript：世界上误解最深的语', 0, 0, 0, 0, 0, 0, 'JavaScript，或者叫 Mocha，或者叫 LiveScript，或者叫 JScript，又或者叫 ECMAScript，是世界上最流行的编程语言之一。事实上世界上的每一台个人电脑都安装并在频繁使用至少一个JavaScript解释器。 JavaScript的流行完全是由于他在WWW脚本语言领域中的地位决', '', 0, 0, 0, 0),
(42, 4, '0', 1270604213, 'h', 0, 1, 0, 0, 0, 'JavaScript基础知识总结', '', '', '', '', '', 1270604213, 1270604213, 1, 'JavaScript基础知识总结', 0, 0, 0, 0, 0, 0, '已经读了《JavaScript DOM 编程艺术》的前几章基础部分，现在凭着记忆，将JavaScript的基础知识总结一下。', '', 0, 0, 0, 0),
(43, 4, '0', 1270604213, 'c,h,a', 0, 1, 0, 0, 0, 'JavaScript的9个陷阱及评点', '', '', '', '', '', 1270604213, 1270604213, 1, 'JavaScript的9个陷阱及评点', 0, 0, 0, 0, 0, 0, '来自Nine Javascript Gotchas, 以下是JavaScript容易犯错的九个陷阱。虽然不是什么很高深的技术问题，但注意一下，会使您的编程轻松些，即所谓make life easier. 笔者对某些陷阱会混杂一些评点。', '', 0, 0, 0, 0),
(44, 4, '0', 1270604213, '', 0, 1, 0, 0, 0, '网页中常用的Javascript代码', '', '', '', '', '', 1270604213, 1270604213, 1, '网页中常用的Javascript代码', 0, 0, 0, 0, 0, 0, 'JavaScript技术可以实现交互式页面，在建立动态页面方面有着其他工具不可比拟的优点。Javascript 在网页设计中,大部分都是用来实现功能,特效的.. 本文列举了一些网页制作中常用的JavaScript技术：', '', 0, 0, 0, 0),
(45, 4, '0', 1270604213, '', 0, 1, 0, 0, 0, 'Javascript优化原则', '', '', '', '', '', 1270604213, 1270604213, 1, 'Javascript优化原则', 0, 0, 0, 0, 0, 0, '首先，与其他语言不同，JS的效率很大程度是取决于JS engine的效率。除了引擎实现的优劣外，引擎自己也会为一些特殊的代码模式采取一些优化的策略。显然，要获得最大效率，就必须要了解引擎的脾气，尽量迎合引擎的口味。所以对于不同的引擎，所作的优化极有可', '', 0, 0, 0, 0),
(46, 4, '0', 1270604213, '', 0, 1, 0, 0, 0, '讨论Ajax之所以优于JSF的原因', '', '', '', '', '', 1270604213, 1270604213, 1, '讨论Ajax之所以优于JSF的原因', 0, 0, 0, 0, 0, 0, 'Sun为什么会搞出一个JSF，JSF为什么会是现在这个样子，我想原因是这样的: 首先，基于组件的Web开发将来会是一个趋势。自包含的组件便于IDE的处理，可以提高开发效率。', '', 0, 0, 0, 0),
(47, 4, '0', 1270604213, '', 0, 1, 0, 0, 0, '警惕AJAX应用开发中的轻罪和死罪', '', '', '', '', '', 1270604213, 1270604213, 1, '警惕AJAX应用开发中的轻罪和死罪', 0, 0, 0, 0, 0, 0, 'AJAX bandwagon是个好去处。它能为您提供更快捷高效，动态更强的应用。但是它也有自己的缺陷。', '', 0, 0, 0, 0),
(48, 4, '0', 1270604213, '', 0, 1, 0, 0, 0, '如何用jQuery简化JavaScript开发', '', '', '', '', '', 1270604213, 1270604213, 1, '如何用jQuery简化JavaScript开发', 0, 0, 0, 0, 0, 0, 'jQuery是我最近发现的一个新工具。jQuery开发团队形容jQuery是“一个快捷、简练的JavaScript库，它可以简化HTML文档检查、事件处理、动画执行、并给你的Web页面增加AJAX交互。”', '', 0, 0, 0, 0),
(49, 4, '0', 1270604213, '', 0, 1, 0, 0, 0, '使用mashups可能会给用户带来不好体验', '', '', '', '', '', 1270604213, 1270604213, 1, '使用mashups可能会给用户带来不', 0, 0, 0, 0, 0, 0, '最近，老板在我们公司使用了一种网络内容过滤设备。至今为止，他们对该设备进行了良好的设置。在使用我的办公用计算机浏览网页时，经过该设备进行了网页内容过滤的Web世界就大为不同了。', '', 0, 0, 0, 0),
(50, 4, '0', 1270604213, '', 0, 1, 0, 0, 0, '如何用JavaScript实现旋转木马', '', '', '', '', '', 1270604213, 1270604213, 1, '如何用JavaScript实现旋转木马', 0, 0, 0, 0, 0, 0, 'Flash动画可以让Web网站看起来很漂亮，但是由于各种原因不是每个人都会在自己的客户端浏览器上安装Flash播放器。如果你或者你的用户不幸安装了64位的Linux发行版，或者你痛恨在自己的Web页面上放动画，那么你就不得不面对没有Flash动画的情况了。', '', 0, 0, 0, 0),
(51, 4, '0', 1270604213, '', 0, 1, 0, 0, 0, '设计与应用JavaScript对象符号JSON', '', '', '', '', '', 1270604213, 1270604213, 1, '设计与应用JavaScript对象符号JS', 0, 0, 0, 0, 0, 0, 'XML是作为一种数据交换工具开发并推出的，但并不是所有开发者都支持这一工具。实际上一些开发者选择开发其它工具。JSON（JavaScript对象符号）就是其中之一。在本文中，我们来详细了解一下JSON的设计与应用。', '', 0, 0, 0, 0),
(52, 4, '0', 1270604213, 'c,h', 0, 1, 0, 0, 0, '完全了解AJAX', '', '', '', '', '', 1270604213, 1270604213, 1, '完全了解AJAX', 0, 0, 0, 0, 0, 0, '尽管AJAX是个相对新生的术语，但其背后的技术却并不新颖。我们从基础开始认识AJAX，一种颠覆性的技术，其改变了Web应用程序的开发和应用方式，使得交互性页面和网站处于目前网络潮流的最前沿。', '', 0, 0, 0, 0),
...
(54, 5, '0', 1270604366, '', 0, 1, 0, 0, 0, '使用Dreamweaver批量做web网页', '', '', '', '', '', 1270604366, 1270604366, 1, '使用Dreamweaver批量做web网页', 0, 0, 0, 0, 0, 0, '做网站，麻烦在更新，特别是大规模更新，工作量非常大。真不知那些创意不断而又勤奋的“站长”，隔三岔五将网站来个“大换血”，是怎么忙过来的。', '', 0, 0, 0, 0),
(55, 5, '0', 1270604366, '', 0, 1, 0, 0, 0, '用 Dreamweaver 8 搞定web标准', '', '', '', '', '', 1270604366, 1270604366, 1, '用,Dreamweaver,8,搞定web标准', 0, 0, 0, 0, 0, 0, '如果您正在读这篇文章，您很可能是已经对 Web 标准有了一定的兴趣，并且对用 DW ( Dreamweaver 的简称)来构建的站点中标准的应用非常好奇。', '', 0, 0, 0, 0),
(56, 5, '0', 1270604366, '', 0, 1, 0, 0, 0, 'Dreamweaver cs3 彩蛋', '', '', '', '', '', 1270604366, 1270604366, 1, 'Dreamweaver,cs3,彩蛋', 0, 0, 0, 0, 0, 0, '随着ADOBE CS3系列产品的亮相，我们最关注的Dreamweaver CS3也获得了最新的消息。首先先来看看传统的Dreamweaver彩蛋是否还在。内容来自中国站长资讯网(www.chinahtml.com)第一个Dreamweaver彩蛋就是：1，在网页中插入一张图像；2，打开属性面板，在图像的缩', '', 0, 0, 0, 0),
(57, 5, '0', 1270604366, 'a', 0, 1, 0, 0, 0, '插入的Flash添加透明或其他参数', '', '', '', '', '', 1270604366, 1270604366, 1, '插入的Flash添加透明或其他参数', 0, 0, 0, 0, 0, 0, 'Dreamweaver升级到8.0.2后，插入Flash时的代码会有所改变，这是Macromedia为解决IE中的Flash会出现控件激活框而作的更新。要为Flash添加透明等参数有两种方法。内容来自中国站长资讯网(www.chinahtml.com)● 用Dreamweaver的属性面板为插入的Flash添加透明属', '', 0, 0, 0, 0),
(58, 5, '0', 1270604366, '', 0, 1, 0, 0, 0, 'Dreamweaver8轻松实现文本的段落缩进', '', '', '', '', '', 1270604366, 1270604366, 1, 'Dreamweaver8轻松实现文本的段落', 0, 0, 0, 0, 0, 0, '如何在Drwamweaver中实现文本的段落缩进，也就成了网页制作中的一大难题。针对这一问题，本文为大家提供以下几种解决办法。', '', 0, 0, 0, 0),
(59, 5, '0', 1270604366, 'p,f,a', 0, 1, 0, 0, 0, 'Dreamweaver基础教程：层及其应用', '', '', '', '', 'http://www.dedecms.com/demoimg/uploads/allimg/c100407/12F60433360W0-19232_lit.jpg', 1270604366, 1270604366, 1, 'Dreamweaver基础教程：层及其应', 0, 0, 0, 0, 0, 0, '层(Layer)是一种 HTML 页面元素，您可以将它定位在页面上的任意位置。层可以包含文本、图像或其它 HTML 文档。层的出现使网页', '', 0, 0, 0, 0),
...
(61, 5, '0', 1270604366, '', 0, 1, 0, 0, 0, 'Dreamweaver CS3新功能', '', '', '', '', '', 1270604366, 1270604366, 1, 'Dreamweaver,CS3新功能', 0, 0, 0, 0, 0, 0, '随着Adobe Dreamweaver CS3的预销我们开始了新一轮的Dreamweavr学习，那么让我们先了解下Dreamweaver CS3都有哪些新功能：', '', 0, 0, 0, 0),
(62, 5, '0', 1270604366, '', 0, 1, 0, 0, 0, '在Dreamweaver8.0.2中为插入的Flash添加透明或其他参数', '', '', '', '', '', 1270604366, 1270604366, 1, '在Dreamweaver8.0.2中为插入的Fl', 0, 0, 0, 0, 0, 0, 'Dreamweaver升级到8.0.2后，插入Flash时的代码会有所改变，这是Macromedia为解决IE中的Flash会出现控件激活框而作的更新。要为Fl', '', 0, 0, 0, 0),
(63, 5, '0', 1270604366, '', 0, 1, 0, 0, 0, '通过Dreamweaver设计网页时组织CSS的建议', '', '', '', '', '', 1270604366, 1270604366, 1, '通过Dreamweaver设计网页时组织C', 0, 0, 0, 0, 0, 0, '一般地讲，样式表（style sheet）就是控制网页内容外观的格式化的规则的集合。可以以三种不同的方式在你的页面中使用CSS：', '', 0, 0, 0, 0),
(64, 5, '0', 1270604366, '', 0, 1, 0, 0, 0, 'Dreamweaver cs3新功能Spry效果试用', '', '', '', '', '', 1270604366, 1270604366, 1, 'Dreamweaver,cs3新功能Spry效果', 0, 0, 0, 0, 0, 0, 'Dreamweaver CS3集成了AJAX框架Spry，使得我最近对Spry感上了兴趣。 再次说明下Spry是Adobe公司推出的AJAX框架，所谓AJAX框架，就先谈目前流行的Web2.0. 1，这些Web2.0站点从页面形式上来看，页面与浏览者的交互很时尚、也很人性化。比如注册信息时输', '', 0, 0, 0, 0),
(65, 5, '0', 1270604366, '', 0, 1, 0, 0, 0, '新手入门：利用DW8掌握网页代码基本格式', '', '', '', '', '', 1270604366, 1270604366, 1, '新手入门：利用DW8掌握网页代码', 0, 0, 0, 0, 0, 0, '说到代码，有人会问：不懂代码能不能制作网页？答案是肯定的。有些人不懂代码同样能制作出非常好的网页。 在Dreamweaver的设计窗口中你每增加或改变一项内容，会自动生成相应代码。那又产生另一个问题：为什么要了解或者熟悉代码呢？可以说熟悉代码将会使你', '', 0, 0, 0, 0),
(66, 5, '0', 1270604366, '', 0, 1, 0, 0, 0, 'Dreamweaver网页制作教程：层及其应用', '', '', '', '', '', 1270604366, 1270604366, 1, 'Dreamweaver网页制作教程：层及', 0, 0, 0, 0, 0, 0, '层（Layer）是一种 HTML 页面元素，您可以将它定位在页面上的任意位置。层可以包含文本、图像或其它 HTML 文档。层的出现使网页从二维平面拓展到三维。可以使页面上元素进行重叠和复杂的布局。首先，请看下图： 我们首先来做一个层 1、 在「窗口」菜单', '', 0, 0, 0, 0),
(67, 5, '0', 1270604366, '', 0, 1, 0, 0, 0, '网页禁止右键菜单及禁止全选代码', '', '', '', '', '', 1270604366, 1270604366, 1, '网页禁止右键菜单及禁止全选代码', 0, 0, 0, 0, 0, 0, 'script language=JavaScriptdocument.oncontextmenu=new Function(event.returnValue=false;);document.onselectstart=new Function(event.returnValue=false;);/script 很好用!', '', 0, 0, 0, 0),
(68, 5, '0', 1270604367, '', 0, 1, 0, 0, 0, '使用Dreamweaver来详细了解CSS的多样性', '', '', '', '', '', 1270604367, 1270604367, 1, '使用Dreamweaver来详细了解CSS的', 0, 0, 0, 0, 0, 0, '说明：√属性继承 ×不继承 [ ]为适应元素类型 无[ ]标出为所有元素字体√Font-family√Font-size 9 10 12 14 16 18 24 36 xx-small x-small small medium large x-large xx-large smaller larger√Color√Font-style normal italic obliqu', '', 0, 0, 0, 0),
(69, 5, '0', 1270604367, '', 0, 1, 0, 0, 0, '用Dreamweaver合理为为网页进行优化', '', '', '', '', '', 1270604367, 1270604367, 1, '用Dreamweaver合理为为网页进行', 0, 0, 0, 0, 0, 0, '我们为了优化网页、加快网页下载速度，除了对图片进行优化之外，还需对网页其他各个元素进行优化。在网页编织过程中如能充分利用编辑工具，也可以在网页制作中达到优化目的。 下面是Dreamweaver中的一些优化技法: 合理调用CSS 进行网页设计时，运用', '', 0, 0, 0, 0),
(70, 5, '0', 1270604367, '', 0, 1, 0, 0, 0, 'Dreamweaver方便快捷编辑网页标签', '', '', '', '', '', 1270604367, 1270604367, 1, 'Dreamweaver方便快捷编辑网页标', 0, 0, 0, 0, 0, 0, '不知各位是否有手写代码的习惯。例如：要在一个单元格插入一段CSS代码，或者一段Javascript代码，怎么做才比较快捷方便呢？ 虽然Dreamweaver已经为我们提供了代码视图，可是必竟还要手工去查找，还要来回地切换。虽然也可以用代码视图与编辑视图并存的', '', 0, 0, 0, 0),
(71, 5, '0', 1270604367, '', 0, 1, 0, 0, 0, 'Dreamweaver8创建自定义代码片段的方法', '', '', '', '', '', 1270604367, 1270604367, 1, 'Dreamweaver8创建自定义代码片段', 0, 0, 0, 0, 0, 0, '一个好的“偷懒”方法，就好比充满困难的路途中出现一盏明灯，简化了好多繁杂的工作，让你有更多精力做其他事情，做的更顺手。', '', 0, 0, 0, 0),
...
(106, 5, '0', 1270708015, 'c,h,a', 1, 1, 0, 76, 0, '{dede:招聘启事 标题=''织梦大家庭新年招募第一波''}', '织梦大家庭新年招募第一波', '', '织梦官方', '织梦官方', '', 1270708015, 1270708089, 1, '新年,招募,第一,波,大家庭,织梦,招聘,启事,标题,ded', 1270775872, 1, 0, 0, 0, 0, '2010年，新一年，新征程……\r\n织梦大家庭招募能够共同创业的新伙伴。\r\n首要特点：织梦需要的是创业伙伴，而非普通员工。织梦是一个大家共同的创业平台！繁华浮躁的时代，我们需要的是『不浮躁』的人。', '', 1, 0, 0, 97),
(107, 4, '0', 1270775824, '', 0, 1, -1, 0, 0, 'PHP正则表达式的几则使用技巧', '', '', 'like', '', '', 1270775824, 1270775824, 4, '', 0, 0, 0, 0, 0, 0, 'PHP正则表达式主要用于字符串的模式分割、匹配、查找及替换操作。使用正则表达式在某些简单的环境下可能效率不高，因此如何更好的使用PHP正则表达式需要综合考虑。 我的PHP正则入门，是起源于网上的一篇文章，这篇文章由浅入深的阐述了PHP正则表达式使用的方', '', 0, 0, 0, 0);
...
(1, 'dedecms', 1270775747, '<li class=''dotline''><a href="[field:arcurl/]">[field:title/]</a></li>', 8, '106,89,88,76,74,35,43,52,1,3,6,7,10,18', ' order by arc.sortrank desc', '', '', 'a:16:{s:3:"row";s:2:"16";s:8:"titlelen";s:2:"42";s:7:"infolen";i:160;s:8:"imgwidth";i:120;s:9:"imgheight";i:120;s:8:"listtype";s:3:"all";s:5:"arcid";i:0;s:9:"channelid";i:0;s:7:"orderby";s:7:"default";s:8:"orderWay";s:4:"desc";s:6:"subday";i:0;s:8:"pagesize";s:1:"8";s:7:"keyword";s:0:"";s:10:"tablewidth";s:4:"100%";s:3:"col";i:1;s:8:"colWidth";s:4:"100%";}');
...
(107, 4, '0', -1, 1, 1270775824, 1270775824, 4);
...
(1, '个人', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', '男', 100, 0, 0, 0, '', 10000, 10, 0, '', 0, '', 1482675508, '', 0, '', -1),
...
(3, 'cfg_cookie_encode', 'cookie加密码', 2, 'string', 'YDwU5gA4PEPGm2k1IBilLOA0db7afv5e'),
